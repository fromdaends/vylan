// Calendar connections — reading and writing one person's Google link (1440).
//
...
// A calendar is personal; see the note at the top of migration 1440.
//
// READS DEGRADE, WRITES REFUSE — the house pattern. Before 1440 there is no
 ...
 * RLS on 1440 scopes the row to auth.uid(), so "your own" is enforced by the
