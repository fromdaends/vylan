...
export type Firm = {
  ...
  // (deletions still confirm — see ALWAYS_CONFIRM_ACTIONS). Owner-editable.
  // May be undefined at runtime until 0570 is applied — readers default it to
  // true (confirmation ON, the safe behavior).
