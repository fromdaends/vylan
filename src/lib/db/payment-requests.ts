...
// 'manual' (migration 1270) means it did not arrive by a rail at all — a
...
// Flip an invoice's auto-chase switch (migration 1270). No status guard: an
...
// only when a row actually changed, so a pre-1270 database (where the column
