// Data layer for the invoice payment ledger (migration 1260).
//
...
// mean migration 1260 hasn't reached this database.
...
// resolved for display. Empty before 1260 is applied — which reads correctly as
