...
- The document checker reads each item's label on its own (including a year like "Bank statement 2022") and already rejects blurry, cropped, or redacted uploads. There are no per-item AI rules to set; write a clear item label instead if the accountant wants the checker to expect something specific.
