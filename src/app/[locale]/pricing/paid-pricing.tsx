...
// The original fixed-plan grid. Hidden while BILLING_ENABLED is false
// (the parent page.tsx renders a "talk to us" pitch instead), and
// brought back verbatim when billing comes online.
export async function PaidPricingSection({ locale }: { locale: "fr" | "en" }) {
