            ...
            <>
              {trialLocked ? (
                <DemoBlockButton
                  ...
                  variant="outline"
                  size="sm"
                  className="group h-8 w-8 gap-0 overflow-hidden px-0 transition-[width,padding,gap] duration-200 hover:w-44 hover:gap-1.5 hover:px-3 focus-visible:w-44 focus-visible:gap-1.5 focus-visible:px-3"
                  labelClassName="max-w-0 overflow-hidden whitespace-nowrap opacity-0 transition-[max-width,opacity] duration-200 group-hover:max-w-40 group-hover:opacity-100 group-focus-visible:max-w-40 group-focus-visible:opacity-100"
                />
              ) : (
                <form action={sendReminderAction}>
                  ...
                  >
                    ...
                    <span className="max-w-0 overflow-hidden whitespace-nowrap opacity-0 transition-[max-width,opacity] duration-200 group-hover:max-w-40 group-hover:opacity-100 group-focus-visible:max-w-40 group-focus-visible:opacity-100">
                      {t("send_reminder")}
                    </span>
                  </Button>
                </form>
