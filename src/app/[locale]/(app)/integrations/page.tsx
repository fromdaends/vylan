  ...
  return (
    <div className="mx-auto max-w-4xl animate-in-fade">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        {/* Document filing used to have a card here. It's a top-level sidebar
            tab now (it's a Vylan-native feature, not a third-party connection),
            and listing it in both places meant the same destination appeared
            twice on one screen. The sidebar tab is the single entry point; this
            hub stays for the actual third-party connections. */}
