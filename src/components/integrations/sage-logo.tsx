// The official Sage brand wordmark (Simple Icons, Sage green #00D639). Kept as
// the real brand color in both light and dark mode — a brand logo should not be
// recolored to theme tokens. Decorative when paired with a visible "Sage 50"
// label; give it an aria-label when it stands alone.
//
// The path + hue come from Simple Icons (CC0), the same source as
// quickbooks-logo.tsx. If you have the exact hex from Sage's press kit, swap the
// fill below — it's the only styling here.
export function SageLogo({
  ...
  return (
    <svg
      ...
      aria-label={ariaHidden ? undefined : "Sage"}
      className={className}
    >
