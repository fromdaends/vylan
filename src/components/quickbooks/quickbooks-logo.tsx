// The official QuickBooks brand mark (Simple Icons, QuickBooks green #2CA01C).
// Kept as the real brand color in both light and dark mode — a brand logo should
// not be recolored to theme tokens. Decorative when paired with a visible
// "QuickBooks" label; give it an aria-label when it stands alone.
export function QuickbooksLogo({
  ...
  return (
    <svg
      ...
      aria-label={ariaHidden ? undefined : "QuickBooks"}
      className={className}
    >
