...
-- 1310 when a merge from main brought in BOTH 1240 and 1250 from two other
...
comment on column payment_requests.amount_paid_cents is
  'Sum of invoice_payments for this invoice, maintained by trigger. ZERO ON PRE-1310 PAID ROWS — outstanding is 0 when status = paid, regardless of this column.';
