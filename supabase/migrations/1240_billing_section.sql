...
--
-- Migration number: 1230 was the highest applied; 1240 per the +10 rule in
-- CLAUDE.md, and the duplicate check printed nothing before it was written.
...
comment on column payment_requests.amount_paid_cents is
  'Sum of invoice_payments for this invoice, maintained by trigger. ZERO ON PRE-1240 PAID ROWS — outstanding is 0 when status = paid, regardless of this column.';
